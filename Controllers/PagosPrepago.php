<?php 
	class PagosPrepago extends Controllers{
		...
		public function PagosPrepago()
		{
			if(empty($_SESSION['permisosMod']['r'])){
				header("Location:".base_url().'/dashboard');
			}
			$data['page_tag'] = "PagosPrepago";
			$data['page_title'] = "PAGOS PREPAGO <small>RASTREO SATELITAL</small>";
			$data['page_name'] = "pagosprepago";
			$data['page_functions_js'] = "functions_productos.js";
			$this->views->getView($this,"pagosprepago",$data);
		}
