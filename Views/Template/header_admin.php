...
<html lang="es">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="RASTREO SATELITAL ISOTECH">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="ISOTECH">
    <meta name="theme-color" content="#B78E49">
    <link rel="shortcut icon" href="<?= media();?>/images/Vultan_Icono.png">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">VULTAN<br><span id="spanid";>RASTREO SATELITAL</span></a>
