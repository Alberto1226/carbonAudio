    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview">
            <a class="app-menu__item" href="#" data-toggle="treeview">
                <i class="app-menu__icon fa fa-map" aria-hidden="true"></i>
                <span class="app-menu__label">Administracion GPS</span>
                <i class="treeview-indicator fa fa-angle-right"></i>
            </a>
            <ul class="treeview-menu">
               
                <li><a class="treeview-item" href="<?= base_url(); ?>/dispositivos"><i class="icon fa fa-circle-o"></i> Dispositivos GPS</a></li>
                <li><a class="treeview-item" href="<?= base_url(); ?>/sim"><i class="icon fa fa-circle-o"></i> Sim</a></li>
                <li><a class="treeview-item" href="<?= base_url(); ?>/planesprepago"><i class="icon fa fa-circle-o"></i> Planes</a></li>
                <li><a class="treeview-item" href="<?= base_url(); ?>/pagosprepago"><i class="icon fa fa-circle-o"></i> Pagos</a></li>
